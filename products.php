...
$stmt = $pdo->prepare('SELECT * FROM products WHERE id BETWEEN 7 AND 9 ORDER BY date_added DESC LIMIT ?,?');
...
$total_products = $pdo->query('SELECT * FROM products WHERE quantity BETWEEN 0 AND 50')->rowCount();
?>
